...
for(const file of ['README.md','docs/index.md','app/page.tsx','lib/omniseed/contracts.mjs','lib/omniseed/transport.mjs','fixtures/startup.json'])if(!fs.existsSync(file))throw new Error(`Missing ${file}`);
