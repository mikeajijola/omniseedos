...
export const operations={
 getRuntimeStatus:{mutation:false},getCompany:{mutation:false},listCapabilities:{mutation:false},getCapability:{mutation:false},listGaps:{mutation:false},getCurrentPlan:{mutation:false},getState:{mutation:false},listActivity:{mutation:false},listObservations:{mutation:false},listFindings:{mutation:false},
