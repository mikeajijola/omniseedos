...
export const operations={
 getRuntimeStatus:{mutation:false},discoverOperations:{mutation:false},resolveIntent:{mutation:false},getCompany:{mutation:false},listCapabilities:{mutation:false},getCapability:{mutation:false},listGaps:{mutation:false},resolveCapability:{mutation:false},getCapabilityRealisation:{mutation:false},listAttention:{mutation:false},getCurrentPlan:{mutation:false},getState:{mutation:false},getInfrastructure:{mutation:false},listActivity:{mutation:false},listObservations:{mutation:false},listFindings:{mutation:false},
